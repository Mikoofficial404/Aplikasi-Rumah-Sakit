...
//    private String tanggal;
    private void tampilkan_data(){
        ...
        model.addColumn("Tanggal Kalduarsa");
         try{
...
try{
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(txtStok, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 155, Short.MAX_VALUE)
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        try{
            String reportPath = "src/Report/reportobat.jasper";
            conn=DriverManager.getConnection("jdbc:mysql://localhost/rumahsakit","root","");
    ...
    private void SimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SimpanActionPerformed
            ...
            try{
                ...
                String kodeobat = "KO" + unixTime;
               String SQL = "INSERT INTO obat (Kode_obat, Namaobat, Harga,Stok,tgl) VALUES ('" + kodeobat + "', '" + txtNama.getText()+"','" +txtJual.getText()+ "','"+txtStok.getText()+"', '" + tanggal + "')";
                 cn.executeUpdate(SQL);
            conn.close();
                tampilkan_data();
    ...
    txtJual.setText(jTable1.getValueAt(jTable1.getSelectedRow(), 2).toString());
    txtStok.setText(jTable1.getValueAt(jTable1.getSelectedRow(), 3).toString());
    try {
        String tanggalobat = jTable1.getValueAt(jTable1.getSelectedRow(), 4).toString();
        SimpleDateFormat fm = new SimpleDateFormat("yyyy-MM-dd");
        Date tanggal = fm.parse(tanggalobat);
        tgl.setDate(tanggal);
    ...
    private void EditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditActionPerformed
        ...
        if (option == JOptionPane.YES_OPTION) {
             String sql = "UPDATE obat SET Kode_obat='" + Kode + "', Namaobat='" + Nama + "', Harga='" + Harga + "', Stok='" + Stok + "', tgl='" + tanggal + "' WHERE Kode_obat ='" + Kode + "'";
              cn.executeUpdate(sql);
            conn.close();
              tampilkan_data();
    ...
    try {
        Koneksi();
        String SQL = "SELECT * FROM obat WHERE Namaobat LIKE '%" + txtNama.getText() + "%'";
