...
try{
    ...
    public dokter() {
        ...
        tampilkan_data();
        batal();
        txtRuang.addItem("Lantai 1 ICU");
        txtRuang.addItem("Lantai 2 UGD");
        txtRuang.addItem("Lantai 3 UGD");
        txtRuang.addItem("Lantai 4 UGD");
        txtBidang.addItem("Bedah");
        txtBidang.addItem("Gigi");
        txtBidang.addItem("Operasi");
        txtBidang.addItem("Umum");
        txtBidang.addItem("Saraf");
        txtJadwal.addItem("Senin");
        txtJadwal.addItem("Selasa");
        txtJadwal.addItem("Rabu");
        txtJadwal.addItem("Kamis");
        txtJadwal.addItem("Jumat");
        txtJadwal.addItem("Sabtu");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(Simpan, javax.swing.GroupLayout.DEFAULT_SIZE, 114, Short.MAX_VALUE)
    ...
    private void HapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_HapusActionPerformed
        ...
        if (option == JOptionPane.YES_OPTION) {
             String sql="DELETE FROM dokter where ID='"+txtKode.getText()+"'";
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
          try{
            String reportPath = "src/Report/reportdokter.jasper";
            conn=DriverManager.getConnection("jdbc:mysql://localhost/rumahsakit","root","");
    ...
    private void SimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SimpanActionPerformed
         Koneksi();
            ...
            String kodeDokter = "KD" + unixTime;
                String SQL = "INSERT INTO dokter VALUES ('" 
                + kodeDokter + "','" 
                + txtNama.getText() + "','" 
                + txtKelamin.getSelectedItem() + "','" 
                + txtBidang.getSelectedItem() + "','" 
                + txtRuang.getSelectedItem() + "','" 
                + txtJadwal.getSelectedItem() + "')";
                 cn.executeUpdate(SQL);
            conn.close();
                tampilkan_data();
    ...
    txtBidang.setSelectedItem(jTable1.getValueAt(jTable1.getSelectedRow(), 2).toString());
    txtRuang.setSelectedItem(jTable1.getValueAt(jTable1.getSelectedRow(), 3).toString());
    txtJadwal.setSelectedItem(jTable1.getValueAt(jTable1.getSelectedRow(), 4).toString());
    txtKelamin.setSelectedItem(jTable1.getValueAt(jTable1.getSelectedRow(), 5).toString());
    ...
    private void EditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditActionPerformed
         try{
                ...
                String Bidang = txtBidang.getSelectedItem().toString();
                String Ruang = txtRuang.getSelectedItem().toString();
                String Jadwal = txtJadwal.getSelectedItem().toString();
        ...
        if (option == JOptionPane.YES_OPTION) {
             String sql = "UPDATE dokter SET ID='" + Kode + "', NamaDokter='" + Nama + "', Bidang='" + Bidang + "', Ruang='" + Ruang+ "', Jadwal='" + Jadwal +"',JenisKelamin='"+ Kelamin+"' WHERE ID ='" + Kode + "'";
              cn.executeUpdate(sql);
            conn.close();
              tampilkan_data();
    ...
    try {
        Koneksi();
         String sql = "SELECT * FROM dokter WHERE NamaDokter LIKE '%" + txtNama.getText() + "%'";
    ...
    txtKode.setText("");
    txtNama.setText("");
    txtBidang.setSelectedItem("");
    txtRuang.setSelectedItem("");
    txtJadwal.setSelectedItem("");
