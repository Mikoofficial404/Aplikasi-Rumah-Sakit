...
try{
    ...
    private void initComponents() {
        ...
        setIconImage(new javax.swing.ImageIcon(getClass().getResource("/Report/Logo Rs.png")).getImage());
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Kode Pasien", "Nama", "Umur", "Jenis Kelamin", "Alamat", "No Telpon"
            }
        ));
    ...
    private void HapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_HapusActionPerformed
        ...
        if (option == JOptionPane.YES_OPTION) {
             String sql="DELETE FROM pasien where Kd_pasien='"+txtKode.getText()+"'";
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
         try{
            String reportPath = "src/Report/ReportPasien.jasper";
            conn=DriverManager.getConnection("jdbc:mysql://localhost/rumahsakit","root","");
    ...
    txtUmur.setText(jTable1.getValueAt(jTable1.getSelectedRow(), 2).toString());
    txtKelamin.setSelectedItem(jTable1.getValueAt(jTable1.getSelectedRow(), 3).toString());
    txtAlamat.setText(jTable1.getValueAt(jTable1.getSelectedRow(), 4).toString());
    txtNohp.setText(jTable1.getValueAt(jTable1.getSelectedRow(), 5).toString());
    ...
    private void EditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditActionPerformed
        ...
        if (option == JOptionPane.YES_OPTION) {
             String sql = "UPDATE pasien SET Kd_pasien='" + Kode + "', namapasien='" + Nama + "', Umur='" + Umur + "', Jeniskelamin='" + kelamin + "', alamat='" + alamat+ "', nohp='" + no_tlp + "' WHERE Kd_pasien ='" + Kode + "'";
              cn.executeUpdate(sql);
            conn.close();
              tampilkan_data();
    ...
    try {
        Koneksi();
        String SQL = "SELECT * FROM pasien WHERE namapasien LIKE '%" + txtNama.getText() + "%'";
